...
public class CardDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cards.Add(new Card(5,"Montapuercos","Plata",'M',6,"-poder",Resources.Load<Sprite>("5-Montapuercos")));
        ...
        cards.Add(new Card(9,"Hechizo de Rayo","Clima",null,null,"range",Resources.Load<Sprite>("9-Hechizo de Rayo")));
        cards.Add(new Card(10,"Montepuerco","Clima",null,null,"melee",Resources.Load<Sprite>("10-Montepuerco")));
        cards.Add(new Card(11,"Hechizo de furia","Aumento",null,null,"bonus",Resources.Load<Sprite>("11-Hechizo de Furia")));
        cards.Add(new Card(12,"Taller del constructor","Aumento",null,null,"bonus",Resources.Load<Sprite>("12-Taller del Constructor")));
        cards.Add(new Card(13,"Controlador aereo","Despeje",null,null,"despeje",Resources.Load<Sprite>("13-Controlador Aereo")));
        cards.Add(new Card(14,"Tornado","Despeje",null,null,"despeje",Resources.Load<Sprite>("14-Tornado")));
        cards.Add(new Card(15,"Duende","Señuelo",null,0,"señuelo",Resources.Load<Sprite>("15-Duende")));
        cards.Add(new Card(16,"Esbirro","Señuelo",null,0,"señuelo",Resources.Load<Sprite>("16-Esbirro")));
